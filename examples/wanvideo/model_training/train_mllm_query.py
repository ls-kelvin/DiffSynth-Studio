"""
Training script for MetaQuery MLLM conditioning.

This script trains:
1. Query token embeddings in the MLLM encoder (frozen original embeddings)
2. DiT's mllm_embedding and cross_attn2 layers
"""
...
class WanMLLMQueryTrainingModule(DiffusionTrainingModule):
    """Training module for MetaQuery MLLM conditioning."""
    ...
    def __init__(
        ...
        # Use MetaQuery pipeline
        self.pipe = WanVideoInterPipeline_MetaQuery.from_pretrained(
        ...
        # Initialize metaquery tokens in MLLM encoder
        # if hasattr(self.pipe, 'mllm_encoder') and self.pipe.mllm_encoder is not None:
        #     if self.pipe.mllm_encoder.num_metaqueries == 0:
        #         # Reinitialize with metaquery support
        #         self.pipe.mllm_encoder.num_metaqueries = num_metaqueries
        #         self.pipe.mllm_encoder._init_metaquery_tokens()
    ...
    def switch_pipe_to_training_mode(
        ...
        # Enable MLLM embedding and cross attention parameters in DiT
...
def wan_parser():
    parser = argparse.ArgumentParser(description="Training script for MetaQuery MLLM conditioning.")
...
if __name__ == "__main__":
    ...
    model = WanMLLMQueryTrainingModule(
