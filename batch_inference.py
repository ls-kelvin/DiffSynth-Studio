...
def parse_args():
    ...
    parser.add_argument("--lora_step", type=int, default=0)
    parser.add_argument("--run_cate", type=str, default="ori")
    parser.add_argument("--output_dir", type=str, default=None)
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--fps", type=int, default=15)
    parser.add_argument("--quality", type=int, default=5)
    parser.add_argument("--use_mllm", action="store_true", help="Enable MLLM condition (default: False)")
...
def main():
    ...
    for i, item in enumerate(local_items):
        prompt = item["Detailed Description"]
